...
extern char XCPKG_WRAPPER_NATIVE_CC_C_SOURCE_STRING[];
extern char XCPKG_WRAPPER_NATIVE_CXX_C_SOURCE_STRING[];
extern char XCPKG_WRAPPER_NATIVE_OBJC_C_SOURCE_STRING[];

extern char XCPKG_WRAPPER_TARGET_CC_C_SOURCE_STRING[];
extern char XCPKG_WRAPPER_TARGET_CXX_C_SOURCE_STRING[];
extern char XCPKG_WRAPPER_TARGET_OBJC_C_SOURCE_STRING[];

extern char XCPKG_HELP_STRING[];
extern char XCPKG_INSTALL_SHELL_SCRIPT_STRING[];
extern char XCPKG_ZSH_COMPLETION_SCRIPT_STRING[];
extern char XCPKG_URL_TRANSFORM_SAMPLE_STRING[];


extern size_t XCPKG_WRAPPER_NATIVE_CC_C_SOURCE_STRING_LENGTH;
extern size_t XCPKG_WRAPPER_NATIVE_CXX_C_SOURCE_STRING_LENGTH;
extern size_t XCPKG_WRAPPER_NATIVE_OBJC_C_SOURCE_STRING_LENGTH;

extern size_t XCPKG_WRAPPER_TARGET_CC_C_SOURCE_STRING_LENGTH;
extern size_t XCPKG_WRAPPER_TARGET_CXX_C_SOURCE_STRING_LENGTH;
extern size_t XCPKG_WRAPPER_TARGET_OBJC_C_SOURCE_STRING_LENGTH;

extern size_t XCPKG_HELP_STRING_LENGTH;
extern size_t XCPKG_INSTALL_SHELL_SCRIPT_STRING_LENGTH;
extern size_t XCPKG_ZSH_COMPLETION_SCRIPT_STRING_LENGTH;
extern size_t XCPKG_URL_TRANSFORM_SAMPLE_STRING_LENGTH;
...
#define XCPKG_ERROR_FORMULA_REPO_IS_BROKEN 27
#define XCPKG_ERROR_FORMULA_REPO_CONFIG_SYNTAX 28
#define XCPKG_ERROR_FORMULA_REPO_CONFIG_SCHEME 29

#define XCPKG_ERROR_FORMULA_SYNTAX     30
#define XCPKG_ERROR_FORMULA_SCHEME     31

#define XCPKG_ERROR_RECEIPT_SYNTAX     35
#define XCPKG_ERROR_RECEIPT_SCHEME     36

#define XCPKG_ERROR_URL_TRANSFORM_ENV_NOT_SET           40
#define XCPKG_ERROR_URL_TRANSFORM_ENV_VALUE_IS_EMPTY    41
#define XCPKG_ERROR_URL_TRANSFORM_ENV_POINT_TO_PATH_NOT_EXIST 42
#define XCPKG_ERROR_URL_TRANSFORM_RUN_NO_RESULT         43

// libgit's error [-35, -1]
#define XCPKG_ERROR_LIBGIT2_BASE    50

// libarchive's error [-30, 1]
#define XCPKG_ERROR_ARCHIVE_BASE    90

// libcurl's error [1, 99]
#define XCPKG_ERROR_NETWORK_BASE    130


#define UPPM_ERROR_PACKAGE_NOT_AVAILABLE 240
#define UPPM_ERROR_PACKAGE_NOT_INSTALLED 241
#define UPPM_ERROR_PACKAGE_NOT_OUTDATED  242
#define UPPM_ERROR_PACKAGE_IS_BROKEN     243

#define UPPM_ERROR_FORMULA_REPO_NOT_FOUND 245
#define UPPM_ERROR_FORMULA_REPO_HAS_EXIST 246
#define UPPM_ERROR_FORMULA_REPO_IS_BROKEN 247
#define UPPM_ERROR_FORMULA_REPO_CONFIG_SYNTAX 248
#define UPPM_ERROR_FORMULA_REPO_CONFIG_SCHEME 249

#define UPPM_ERROR_FORMULA_SYNTAX     250
#define UPPM_ERROR_FORMULA_SCHEME     251
